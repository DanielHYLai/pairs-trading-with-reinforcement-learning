...
from model.environment_transaction_fee import envTrader_fee
...
agent = DQN_Agent(
    ...
    pre_train_model="pre-train-fixWindow/cum_pre-train-model_ 3.9925.pth",
...
while not stop_flag:
    ...
    if cum_reward > max_cum_reward:
        ...
        agent.save_model(f"{path}/pre-train-model_{cum_reward: .4f}.pth")
        write_cache_file(result, f"{path}/train_result_{cum_reward: .4f}.pkl")
