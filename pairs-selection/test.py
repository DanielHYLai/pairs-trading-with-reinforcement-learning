...
agent = DQN_Agent(
    ...
    pre_train_model="pre-train/pre-train-model_39120.pth",
...
while not stop_flag:
    ...
    if cum_reward > max_cum_reward:
        ...
        agent.save_model(f"pre-train-model_test_{idx+85}.pth")
        write_cache_file(temp_result, f"temp_result_{idx+85}.pkl")
